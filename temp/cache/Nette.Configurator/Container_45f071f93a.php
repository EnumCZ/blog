<?php
// source: /home/radek/MEGA/projects/blog/app/config/config.neon 
// source: /home/radek/MEGA/projects/blog/app/config/config.local.neon 

class Container_45f071f93a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => '/home/radek/MEGA/projects/blog/app',
			'wwwDir' => '/home/radek/MEGA/projects/blog/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => '/home/radek/MEGA/projects/blog/app/../temp',
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/home/radek/MEGA/projects/blog/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/radek/MEGA/projects/blog/app/../temp/cache',
	...
	{
		return new Container_45f071f93a_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	public function createServiceDoctrine__default__metadataDriver()
	{
		...
		$service->addDriver($this->getService('doctrine.default.driver.Kdyby_Doctrine.annotationsImpl'),
			'Kdyby\Doctrine');
		$service->setDefaultDriver(new Kdyby\Doctrine\Mapping\AnnotationDriver(['/home/radek/MEGA/projects/blog/app'],
			$this->getService('annotations.reader'), $this->getService('doctrine.cache.default.metadata')));
		return $service;
	}
	...
	public function createServiceDoctrine__default__ormConfiguration()
	{
		...
		$service->setProxyDir('/home/radek/MEGA/projects/blog/app/../temp/proxies');
	...
	{
		return new Container_45f071f93a_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory($this);
	}
	...
	{
		return new Container_45f071f93a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('/home/radek/MEGA/projects/blog/app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/home/radek/MEGA/projects/blog/app/../temp/proxies';
	}
...
final class Container_45f071f93a_Component_ICategoryFormFactoryImpl_69_Component_ICategoryFormFactory implements Component\ICategoryFormFactory
{
	...
	public function __construct(Container_45f071f93a $container)
	{
	...
	public function create(): Component\CategoryForm
	{
		...
		$service->onAdded = $this->container->getService('events.manager')->createEvent(['Component\CategoryForm', 'onAdded'],
			$service->onAdded, NULL, FALSE);
...
final class Container_45f071f93a_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{
	private $container;
...
final class Container_45f071f93a_Kdyby_Doctrine_DI_IRepositoryFactoryImpl_doctrine_repositoryFactory_default_defaultRepositoryFactory implements Kdyby\Doctrine\DI\IRepositoryFactory
{
	private $container;
...
final class Container_45f071f93a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('/home/radek/MEGA/projects/blog/app/../temp/cache/latte');
