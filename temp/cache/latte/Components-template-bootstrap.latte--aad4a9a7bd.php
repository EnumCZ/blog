<?php
// source: /home/radek/MEGA/projects/blog/vendor/ipub/visual-paginator/src/IPub/VisualPaginator/Components/template/bootstrap.latte

use Latte\Runtime as LR;

class Templateaad4a9a7bd extends Latte\Runtime\Template
{
...
<?php
				...
				if ($_tmp = array_filter([$useAjax ? 'ajax' : NULL])) echo ' class="', LR\Filters::escapeHtmlAttr(implode(" ", array_unique($_tmp))), '"' ?>>« Previous</a></li>
<?php
			}
?>
...
<?php
				...
				if ($_tmp = array_filter([$useAjax ? 'ajax' : NULL])) echo ' class="', LR\Filters::escapeHtmlAttr(implode(" ", array_unique($_tmp))), '"' ?>>Next »</a></li>
<?php
			}
?>
</ul>
